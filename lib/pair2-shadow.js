...
export function calculatePair2Shadow(inputRows,win6Input=''){
  ...
  return {version:VERSION,alpha:ALPHA,dna_window:[3,4,5],dna_type:'exact_pair_top2_or_bottom2_reverse_equivalent',world_win:false,pairs};
}
