...
export function calculateVeltrix(rows,options={}){
  ...
  for(const mode of ['A','B']){
    const rud=crossRudEngine(clean,mode),rank=rankMode(clean,mode,rud,targetDate),win7=sharedWin7(clean,rank,rud);
    ...
    result[mode]={
      ...
      fusionBonus:null,
      hybridVersion:`MODE_${mode}_SHARED_PIPELINE_DAY_YEAR_BONUS_V8`
    };
  }
  return result;
}
