...
export default async function handler(req,res){
  ...
  try{
    ...
    const rows=(snapshots||[])
      ...
      .map(s=>({
        market_name:marketById.get(s.market_id)?.market_name||s.market_id,
        market_key:marketById.get(s.market_id)?.market_key||null,
        mode:s.mode,win6:s.win6,reserve7:s.reserve7,
        rud_top:s.rud_top,rud_bottom:s.rud_bottom,
        pair2_top:s.pair2_top,pair3_top:s.pair3_top,
